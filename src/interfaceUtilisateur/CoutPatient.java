 ...
 * @author annelise
 */
public class CoutPatient extends javax.swing.JFrame {

    /**
     * Creates new form CoutPatient
     */
    public CoutPatient() {
        initComponents();
    }
  ...
  private void jTree2ValueChanged(javax.swing.event.TreeSelectionEvent evt) {                                    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoutPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoutPatient().setVisible(true);
            }
        });
    }
